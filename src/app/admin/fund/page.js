    ...
    <div className="space-y-8">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <h1 className="text-2xl font-bold tracking-tight text-white flex items-center">
          <Landmark className="mr-3 text-indigo-400" />
          Fund Analytics & History
        </h1>
        
        <div className="bg-gray-900 border border-gray-800 p-1 rounded-lg flex items-center">
           {ranges.map(range => (
             <button
                key={range}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-indigo-950/20 border border-indigo-500/20 rounded-xl p-6 shadow-sm">
