  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-gray-800 pb-6 gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white flex items-center mb-2">
        ...
        <div className="bg-gray-900 border border-gray-800 px-4 py-2 rounded-lg flex items-center hidden sm:flex">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {reports.map((report) => (
          <div key={report.id} className="group bg-gray-900 border border-gray-800 rounded-xl p-6 hover:bg-gray-800 transition-colors shadow-sm relative overflow-hidden flex flex-col h-full">
            ...
            <div className="flex-grow">
               <div className="inline-flex items-center text-xs font-semibold tracking-wider uppercase text-indigo-400 mb-3 bg-indigo-400/10 px-2 py-1 rounded">
                 {format(new Date(report.month + '-01'), 'MMM yyyy')}
               </div>
               <h3 className="text-lg font-medium text-white mb-2 leading-snug group-hover:text-indigo-200 transition-colors">
                 {report.title}
               </h3>
      ...
      {reports.length === 0 && (
        <div className="py-20 flex flex-col items-center justify-center text-center bg-gray-900/50 border border-gray-800 border-dashed rounded-xl">
